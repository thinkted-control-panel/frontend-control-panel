import svgPaths from "./svg-tvb3qfefva";
...
function Rodape() {
  return (
    <div className="absolute bg-white h-[38px] left-[calc(50%+80.5px)] rounded-[100px] top-[703px] translate-x-[-50%] w-[683px]" data-name="rodapé">
  ...
  return (
    <div className="relative shrink-0 size-[16px]" data-name="setting">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="setting">
          <g id="Vector">
            <path d={svgPaths.p11a7d340} stroke="var(--stroke-0, #0D0C0B)" strokeLinecap="round" strokeLinejoin="round" strokeOpacity="0.8" strokeWidth="1.2" />
            <path d={svgPaths.p1bda5480} stroke="var(--stroke-0, #0D0C0B)" strokeLinecap="round" strokeLinejoin="round" strokeOpacity="0.8" strokeWidth="1.2" />
          </g>
        </g>
      </svg>
    </div>
...
function Frame28() {
  return (
    <div className="content-stretch flex gap-[12px] items-center relative shrink-0">
      <Notificacao />
      <div className="flex h-[24px] items-center justify-center relative shrink-0 w-0" style={{ "--transform-inner-width": "300", "--transform-inner-height": "300" } as React.CSSProperties}>
...
function Component7() {
  return (
    <div className="bg-[#1d43be] content-stretch flex gap-[10px] h-[32px] items-center justify-center p-[12px] relative rounded-[6px] shrink-0" data-name="Component 9">
      <div className="flex items-center justify-center relative shrink-0 size-[18px]" style={{ "--transform-inner-width": "300", "--transform-inner-height": "150" } as React.CSSProperties}>
        <div className="flex-none rotate-[90deg]">
          <Add />
        </div>
      </div>
      <p className="css-ew64yg font-['Poppins:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#fcfcfd] text-[14px]">Categoria</p>
    </div>
  );
}
...
function Frame56() {
  return (
    <div className="absolute content-stretch flex items-center justify-between left-[calc(50%-453.5px)] top-[154px] w-[1113.5px]">
      <Frame31 />
      <Component7 />
    </div>
  );
...
function BarraLib() {
  return (
    <div className="absolute h-[39px] left-[calc(50%-459px)] top-[97px] w-[308px]" data-name="Barra - lib">
      {/* Barra de abas removida - usando componente customizado */}
    </div>
  );
}
...
function Frame48() {
  return (
    <div className="h-[21px] relative shrink-0 w-[739.75px]">
      <Frame47 />
    </div>
  );
}
...
function Frame37() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[724.75px]">
      <Categorias />
    </div>
  );
}
...
function Frame36() {
  return (
    <div className="h-[40px] relative shrink-0 w-full">
      <div aria-hidden="true" className="absolute border-[#eef3ff] border-b border-solid inset-0 pointer-events-none" />
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[111px] items-center p-[16px] relative size-full">
          <Frame34 />
          <Frame37 />
          <Frame35 />
        </div>
...
function Frame82() {
  return (
    <div className="absolute left-[calc(50%-453px)] rounded-[8px] top-[204px] w-[1113px]">
...
export default function ItensCategorias() {
  return (
    <div className="bg-white relative size-full" data-name="Itens - categorias">
      <Frame3 />
      <Rodape />
      <NavbarTes />
      <NabvarPai />
