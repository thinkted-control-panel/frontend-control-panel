import svgPaths from "./svg-8ssbkx7zji";
    ...
    <div className="relative shrink-0 size-[16px]" data-name="user">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="user">
          ...
          <g id="Vector">
            <path d={svgPaths.p32c7fa00} stroke="var(--stroke-0, #1D43BE)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2" />
            <path d={svgPaths.p29a85e00} stroke="var(--stroke-0, #1D43BE)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2" />
          </g>
        </g>
      </svg>
    </div>
...
function Frame6() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0">
      <Home5 />
      <div className="flex flex-col font-['Poppins:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[14px] text-[rgba(13,12,11,0.8)] w-[90px]">
        <p className="css-4hzbpn leading-[normal]">Comum</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0">
      ...
      <div className="css-g0mm18 flex flex-col font-['Poppins:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[14px] text-[rgba(13,12,11,0.8)]">
        <p className="css-ew64yg leading-[normal]">Admins</p>
      </div>
    </div>
  );
}
...
function NavbarUsuarips() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative shrink-0 w-[176px]" data-name="Navbar - usuárips">
...
export default function NavbarTes() {
  return (
    <div className="bg-white content-stretch flex items-start justify-center relative size-full" data-name="navbar - tes">
